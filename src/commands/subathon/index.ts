...
const subathon: CommandInt = {
  ...
  Code: async (client: Actions, channel: string, userstate: CommonUserstate, context: Array<string>) => {
    ...
    client.action(channel, `@${tagged} Subathon is on pause while Esfand goes to L.A. Timer is paused, donations and subs still add to the timer. Full details here: https://www.youtube.com/watch?v=uwgGPzYtoek`);
  }
}
